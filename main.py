...
DISCORD_TOKEN = "OTc1MDU0MTA5ODE0MTkwMDkw.GsNmuD.TAvo3jCXEBu2ShQZZPctljoroazt30U8v8ffQ0"
...
#AWS STUFF
ACCESS_KEY = "AKIAW76T3D74W6RSMA77" #from input
SECRET = "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" #from input
...
async def scan(ctx):
        ...
        await ctx.channel.send("Please enter the last number")
